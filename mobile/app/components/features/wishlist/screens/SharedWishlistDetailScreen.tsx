...
import { usePublicWishlistDetail } from '@/app/hooks/usePublicWishlistDetail';
...
import { WishlistFilters, SortOption } from '@/app/components/features/wishlist/WishlistFilters';
...
export default function SharedWishlistDetailScreen() {
